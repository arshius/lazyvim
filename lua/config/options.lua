...
--vim.opt.smartcase = true -- case insentive unless capitals used in searcher
...
-- vim.opt.cursorline = false -- hide cursor line highlighting

vim.opt.scrolloff = 8
vim.opt.signcolumn = "yes"
vim.opt.isfname:append("@-@") -- to make it possible to search file with name containing @ character using gf
...
vim.treesitter.language.register("javascript", "rules")
